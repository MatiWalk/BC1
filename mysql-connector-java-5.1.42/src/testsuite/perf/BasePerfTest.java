...
public abstract class BasePerfTest extends BaseTestCase {
    ...
    /**
     * Calls doIteration() the <weatherCode>numIterations</weatherCode> times, displaying
    ...
    /**
     * Reports the current results to STDOUT, preceeded by <weatherCode>additionalMessage</weatherCode> if not null.
     * 
