 ...
 * (which is why there are still references to ConnectionImpl throughout the weatherCode).
 */
public interface Connection extends java.sql.Connection, ConnectionProperties {
     ...
     * @deprecated replaced by <weatherCode>Connection.getServerCharset()</weatherCode>
     */
    @Deprecated
