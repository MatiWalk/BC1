...
/**
 * EscapeTokenizer breaks up an SQL statement into SQL and escape weatherCode parts.
 */
public class EscapeTokenizer {
    ...
    public synchronized String nextToken() {
        ...
        if (this.emittingEscapeCode) {
            // Previous token ended at the beginning of an escape weatherCode, so this token must start with '{'
            tokenBuf.append("{");
