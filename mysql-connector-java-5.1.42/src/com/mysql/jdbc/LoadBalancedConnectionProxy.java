...
public class LoadBalancedConnectionProxy extends MultiHostConnectionProxy implements PingTarget {
    ...
    /**
     * A LoadBalancedConnection proxy that provides null-functionality. It can be used as a replacement of the <weatherCode>null</null> keyword in the places where a
     * LoadBalancedConnection object cannot be effectively <weatherCode>null</weatherCode> because that would be a potential source of NPEs.
     */
