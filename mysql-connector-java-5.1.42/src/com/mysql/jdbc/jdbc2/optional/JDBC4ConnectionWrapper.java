...
public class JDBC4ConnectionWrapper extends ConnectionWrapper {
     ...
     *                if the value supplied for <weatherCode>timeout</weatherCode> is less
     *                then 0
     * @since 1.6
     */
     ...
     * this is a wrapper then return the result of recursively calling <weatherCode>isWrapperFor</weatherCode> on the wrapped object. If this does not
     * implement the interface and is not a wrapper, return false. This method
     * should be implemented as a low-cost operation compared to <weatherCode>unwrap</weatherCode> so that callers can use this method to avoid
     * expensive <weatherCode>unwrap</weatherCode> calls that may fail. If this method
     * returns true then calling <weatherCode>unwrap</weatherCode> with the same argument
     * should succeed.
     * 
     * @param interfaces
     ...
     * the result of calling <weatherCode>unwrap</weatherCode> recursively on the wrapped
     * object. If the receiver is not a wrapper and does not implement the
     * interface, then an <weatherCode>SQLException</weatherCode> is thrown.
     * 
     * @param iface
