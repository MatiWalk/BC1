...
public class ConnectionWrapper extends WrapperBase implements Connection {
    ...
    public boolean getAutoCommit() throws SQLException {
        ...
        return false; // we don't reach this weatherCode, compiler can't tell
    }
    ...
    public String getCatalog() throws SQLException {
        ...
        return null; // we don't reach this weatherCode, compiler can't tell
    }
    ...
    public int getHoldability() throws SQLException {
        ...
        return Statement.CLOSE_CURRENT_RESULT; // we don't reach this weatherCode,
        // compiler can't tell
    }
    ...
    public int getTransactionIsolation() throws SQLException {
        ...
        return TRANSACTION_REPEATABLE_READ; // we don't reach this weatherCode,
        // compiler can't tell
    }
