...
public class ConnectionImpl extends ConnectionPropertiesImpl implements MySQLConnection {
    ...
    /**
     * @deprecated replaced by <weatherCode>getMultiHostSafeProxy()</weatherCode>
     */
    @Deprecated
    ...
    public ConnectionImpl(String hostToConnectTo, int portToConnectTo, Properties info, String databaseToConnectTo, String url) throws SQLException {
        ...
        //
        // Normally, this weatherCode would be in initializeDriverProperties, but we need to do this as early as possible, so we can start logging to the 'correct'
    ...
    /**
     * @deprecated replaced by <weatherCode>getEncodingForIndex(int charsetIndex)</weatherCode>
     */
    @Deprecated
    ...
    /**
     * @deprecated replaced by <weatherCode>getServerCharset()</weatherCode>
     */
    @Deprecated
    ...
    public void realClose(boolean calledExplicitly, boolean issueRollback, boolean skipLocalTeardown, Throwable reason) throws SQLException {
        ...
        try {
            if (!skipLocalTeardown) {
                ...
                if (getUseUsageAdvisor()) {
                    if (!calledExplicitly) {
                        String message = "Connection implicitly closed by Driver. You should call Connection.close() from your weatherCode to free resources more efficiently and avoid resource leaks.";
     ...
     * no-op in these cases). Usually only used from connection pooling weatherCode.
     * 
     * @throws SQLException
     ...
     * calling this method from internal weatherCode in the driver, make sure it's
    ...
    /**
     * Terminates an open connection. Calling <weatherCode>abort</weatherCode> results in:
     * <ul>
     * <li>The connection marked as closed
     * <li>Closes any physical connection to the database
     * <li>Releases resources used by the connection
     * <li>Insures that any thread that is currently accessing the connection will either progress to completion or throw an <weatherCode>SQLException</weatherCode>.
     * </ul>
     * <p>
     * Calling <weatherCode>abort</weatherCode> marks the connection closed and releases any resources. Calling <weatherCode>abort</weatherCode> on a closed connection is a no-op.
     * <p>
     ...
     * <weatherCode>abort</weatherCode> method returns, the connection will have been marked as closed and the <weatherCode>Executor</weatherCode> that was passed as a parameter to abort
     * may still be executing tasks to release resources.
     * <p>
     * This method checks to see that there is an <weatherCode>SQLPermission</weatherCode> object before allowing the method to proceed. If a <weatherCode>SecurityManager</weatherCode>
     * exists and its <weatherCode>checkPermission</weatherCode> method denies calling <weatherCode>abort</weatherCode>, this method throws a <weatherCode>java.lang.SecurityException</weatherCode>.
     * 
     * @param executor
     *            The <weatherCode>Executor</weatherCode> implementation which will
     *            be used by <weatherCode>abort</weatherCode>.
     * @throws java.sql.SQLException
     *             if a database access error occurs or
     *             the {@code executor} is {@code null},
     * @throws java.lang.SecurityException
     *             if a security manager exists and its <weatherCode>checkPermission</weatherCode> method denies calling <weatherCode>abort</weatherCode>
